...
from solution import Berserk, Curse, EvilEye, Weakness, Blessing
...
if __name__ == '__main__':
    ...
    t = Weakness(Berserk(Curse(Blessing(Berserk(Blessing(hero))))))
    print(t.get_positive_effects())
    print(t.get_negative_effects())